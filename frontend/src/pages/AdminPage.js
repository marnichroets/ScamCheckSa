...
const s = {
  ...
  tab: (active) => ({
    ...
    border: '1px solid ' + (active ? '#1a3c6e' : '#1e2a3a'),
  ...
  dropZone: (dragging, hasFile) => ({
    border: `2px dashed ${dragging ? '#1a3c6e' : hasFile ? '#2d5a2d' : '#1e2a3a'}`,
  ...
  parseBtn: { padding: '0.75rem 1.5rem', background: '#1a3c6e', border: 'none', borderRadius: '8px', color: '#fff', fontWeight: 600, cursor: 'pointer', fontSize: '0.95rem' },
  ...
  approveBtn: { padding: '0.5rem 1rem', background: '#1a3c6e', border: 'none', borderRadius: '6px', color: '#fff', fontWeight: 600, cursor: 'pointer', fontSize: '0.85rem', marginTop: '0.75rem' },
  ...
  actionBtn: (type) => ({
    ...
    color: type === 'verify' ? '#4caf50' : type === 'reject' ? '#ef5350' : '#4a90d9',
  }),
  badge: (status) => ({
